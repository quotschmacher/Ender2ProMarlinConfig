...
#define STRING_CONFIG_H_AUTHOR "(quotschmacher, Ender-2 Pro)" // Who made the changes.
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 300, 300, 70, 1000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35, -13, -4.21 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_HEIGHT      4.83        // (mm) Z height of nozzle at tramming points
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { -5, (Y_MAX_POS - 10), 20 }
